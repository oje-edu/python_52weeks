...
# TURN LIST OF LIST INTO DICTIONARY
devices = list()
...
# PRETTY PRINT DEVICES AS LIFT OF DICTS
print("\n----- Devices as list of dicts ----------")
pprint(devices)

# PART II: ----- Read CSV file created by spreadsheet ----------
with open("devices_for_csv_example - Tabellenblatt1.csv", "r") as csv_in:
    csv_reader = csv.reader(csv_in)
...
print("\n----- compare spreadsheet data with out version ----------")
if filecmp.cmp("devices_for_csv_example - Tabellenblatt1.csv", "l_00_inventory_back_to_csv.csv"):
    print("-- workx: spreadsheet devices equals out version")
else:
